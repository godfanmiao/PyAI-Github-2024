...
- 基础篇：涵盖了Python 3.11的编程基础、基于Pandas 1.5的数据分析，以及使用Scikit-learn 1.3解决大量经典的单机（单核/多核）机器学习问题。
- 进阶篇：介绍如何使用PyTorch 2.0、TensorFlow 2.12，以及PaddlePaddle 2.5各自搭建多种深度学习网络框架，甚至是基于PySpark 3.2的ML编程库完成一些常见的分布式机器学习任务。
...
- 互联网软件行业高级产品经理；工程师（职称：中级）
- 澳洲国立大学金融学硕士、南开大学经济学学士
- 获日本、中国发明专利授权3项，GUI外观设计专利授权10项
